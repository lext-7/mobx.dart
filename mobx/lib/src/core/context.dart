...
class ReactiveConfig {
  ...
  final Set<ReactionErrorHandler> _reactionErrorHandlers = Set<ReactionErrorHandler>();
...
class ReactiveContext {
  ...
  Derivation _startTracking(Derivation derivation) {
    ...
    derivation._newObservables = Set<Atom>();
  ...
  void _bindDependencies(Derivation derivation) {
    ...
    derivation
      ...
      .._newObservables = Set<Atom>(); // No need for newObservables beyond this point
  }
  ...
  void _clearObservables(Derivation derivation) {
    ...
    derivation._observables = Set<Atom>();
